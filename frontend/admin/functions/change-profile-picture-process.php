...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['profile_picture'])) {
    ...
    if (in_array($fileType, $allowedExtensions)) {
        ...
        if (move_uploaded_file($fileTmpName, $fileDestination)) {
            ...
            if ($stmt->execute()) {
                ...
                header('Location: /Kapelicious/frontend/admin/pages/change-profile-picture.php?success=1');
                exit;
            } else {
    ...
    header('Location: /Kapelicious/frontend/admin/pages/change-profile-picture.php?error=1');
    exit;
}
?>